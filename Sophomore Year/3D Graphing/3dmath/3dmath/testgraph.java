...
public class testgraph extends JFrame implements KeyListener,EventListener,
						MouseListener,MouseMotionListener,MouseWheelListener
{
	...
	Tree x=null;
	Tree y=new expressiontree().getTree("5*(sin(x/5)+sin(z/5))");
	Tree z=null;
    ...
    {
    	testgraph v=new testgraph();
    }
    public testgraph()
    {
    	gr.init(x,"x",y,"y",z,"z",25,1);
